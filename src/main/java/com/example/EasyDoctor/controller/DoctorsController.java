...
import com.example.EasyDoctor.services.DoctorServiceImpl;
...
public class DoctorsController {
    ...
    public String Search(Model model, @Param("Keyword") String keyword) {
        List<Doctors> docs = doctorServiceImpl.listAll(keyword);
...
//    }
    ...
    public String saveDoctor(@ModelAttribute("doctors") Doctors doctors){
       doctorServiceImpl.save(doctors);
        return "docall";
    }
    ...
    public ModelAndView showEditDoctorPage(@PathVariable(name = "id")int id) {
        ...
        Doctors doctors = doctorServiceImpl.get((long) id);
    ...
    public String deleteDoctor(@PathVariable(name = "id")int id) {
        doctorServiceImpl.delete((long) id);
